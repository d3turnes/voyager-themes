                    ...
                    <div class="row">
                        ...
                        @if(count($themes) < 1)
                            <div class="col-md-12">
                                ...
                                <p>That's ok, you can download a <a href="https://github.com/thedevdojo/sample-theme"
                                                                    target="_blank">sample theme here</a>, or download
                                    the <a href="https://github.com/thedevdojo/pages" target="_blank">default pages
                                        here</a>. Make sure to download the theme and place it in your themes folder.
                                </p>
                            </div>
                        @endif
                        ...
                        @foreach($themes as $theme)
                            ...
                            <div class="col-md-4">
                                <div class="theme">
                                    <img class="theme_thumb"
                                         src="{{ url('themes' ) }}/{{ $theme->folder }}/{{ $theme->folder }}.jpg">
                                    <div class="theme_details">
                                        <h4>{{ $theme->name }}
                                            <span>@if(isset($theme->version)){{ 'version ' . $theme->version }}@endif</span>
                                        </h4>
                                        ...
                                        @else
                                            <a class="btn btn-outline pull-right"
                                               href="{{ route('voyager.theme.activate', $theme->folder) }}"><i
                                                        class="voyager-check"></i> Activate Theme</a>
                                        @endif
                                        <a href="{{ route('voyager.theme.options', $theme->folder) }}"
                                           class="voyager-params theme-options"></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><i class="voyager-trash"></i> {{ __('Are you sure you want to delete this
						theme?') }}</h4>
                    </div>
