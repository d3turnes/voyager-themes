...
if (!class_exists(RowTypeClass::class)) {
	class RowTypeClass {
...
if (!class_exists(DataTypeContentClass::class)) {
...
if (!function_exists('theme_field')) {
    ...
    function theme_field($type, $key, $title, $content = '', $details = '', $placeholder = '', $required = 0)
    {
        ...
        $theme = \D3turnes\VoyagerThemes\Models\Theme::where('folder', '=', ACTIVE_THEME_FOLDER)->first();
...
if (!function_exists('theme')) {
    ...
    {
        $theme = \D3turnes\VoyagerThemes\Models\Theme::where('active', '=', 1)->first();
